...
import RegOpen from "./pages/RegOpen.tsx";
        ...
        >
            <Router>
                <Routes>
                    ...
                    <Route path="/regOpen" element={<RegOpen/>} key="/regOpen"/>
                    <Route path="/registration" element={<Registration open={0}/>} key="/registration"/>
